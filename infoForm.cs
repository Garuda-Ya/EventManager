...
namespace EventApp
{
    public partial class infoForm : Form
    {
        ...
        public infoForm(DataRow row, bool select)
        {
            InitializeComponent();
            ...
            dateEvent.Text = ds.Tables[0].Rows[0]["DateEvent"].ToString().Substring(0, ds.Tables[0].Rows[0]["DateEvent"].ToString().Length - 3);
            phoneBox.Text = ds.Tables[0].Rows[0]["Phone"].ToString();
